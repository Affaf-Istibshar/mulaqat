...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mulaqatAuthUserSubject.add(
      MulaqatAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MulaqatAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MulaqatAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MulaqatAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    mulaqatAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
